...
CREATE TABLE "Flowchart" (
    ...
    "name" TEXT NOT NULL DEFAULT 'New Flowchart',
...
-- CreateIndex
CREATE UNIQUE INDEX "Flowchart_apiKey_key" ON "Flowchart"("apiKey");

-- CreateIndex
CREATE INDEX "Flowchart_isPublished_idx" ON "Flowchart"("isPublished");

-- CreateIndex
CREATE INDEX "Flowchart_userId_idx" ON "Flowchart"("userId");
