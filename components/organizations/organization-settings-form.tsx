...
import { Building2, School, Users2, Settings, AlertOctagon, AlertTriangle, Loader2, Trash2, Check } from "lucide-react";
...
type OrganizationType = "BUSINESS" | "SCHOOL" | "NONPROFIT";
...
export function OrganizationSettingsForm({ organizationId }: OrganizationSettingsFormProps) {
  ...
  const [newMemberRole, setNewMemberRole] = useState<Exclude<MemberRole, "OWNER">>("MEMBER");
  ...
  const handleRemoveMember = async (memberId: string) => {
    try {
      const response = await fetch(
        `/api/organizations/${organizationId}/members?userId=${memberId}`,
        {
          method: "DELETE",
        }
      );
                ...
                <form onSubmit={handleAddMember} className="space-y-4">
                  <div className="flex items-end gap-2">
                    ...
                    <div className="w-[140px]">
                      ...
                      <Select
                        value={newMemberRole}
                        onValueChange={(value: Exclude<MemberRole, "OWNER">) => setNewMemberRole(value)}
                        disabled={isAddingMember}
                      >
                    ...
                    <div className="flex items-center gap-2">
                      {canManageOrganization && member.role !== "OWNER" ? (
                        <>
                          <Select
                            value={member.role}
                            onValueChange={(value: Exclude<MemberRole, "OWNER">) =>
